...
import {
    ...
    SheetHeader,
    SheetTitle,
} from "@/components/ui/animate-ui/sheet";
...
import {
  Highlight,
  HighlightItem,
} from "@/components/ui/animate-ui/primitives/highlight";
...
function SidebarInset({ className, ...props }: SidebarInsetProps) {
  return (
    <main
      ...
      className={cn(
        "bg-background relative flex w-full flex-1 flex-col border-[1px] border-muted/10",
...
function SidebarMenuSubButton({
  ...
  return (
    <HighlightItem activeClassName="bg-sidebar-accent/60 text-sidebar-accent-foreground rounded-md">
      <Comp
